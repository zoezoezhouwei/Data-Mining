...
![](./figure-markdown_strict copy/unnamed-chunk-2-1.png)
...
![](./figure-markdown_strict copy/unnamed-chunk-3-1.png)
...
![](./figure-markdown_strict copy/unnamed-chunk-4-1.png)
...
![](./figure-markdown_strict copy/unnamed-chunk-5-1.png)
...
![](./figure-markdown_strict copy/unnamed-chunk-6-1.png)
...
![](./figure-markdown_strict copy/unnamed-chunk-7-1.png)
...
![](./figure-markdown_strict copy/unnamed-chunk-8-1.png)
...
![](./figure-markdown_strict copy/unnamed-chunk-9-1.png)
...
![](./figure-markdown_strict copy/unnamed-chunk-10-1.png)
...
For most of carriers, the flights in summer also tend to delay, but not
...
![](./figure-markdown_strict copy/figure-markdown_strict/unnamed-chunk-13-1.png)

    ggplot(data = sclass65) + 
      geom_point(mapping = aes(x = mileage, y = price))  

![](./figure-markdown_strict copy/unnamed-chunk-14-1.png)
...
![](./figure-markdown_strict copy/unnamed-chunk-24-1.png)
...
![](./figure-markdown_strict copy/unnamed-chunk-25-1.png)

    p_test + geom_line(aes(x = mileage, y = s350_pred), color='red', size=0.5)

![](./figure-markdown_strict copy/unnamed-chunk-25-2.png)
...
![](./figure-markdown_strict copy/unnamed-chunk-35-1.png)
...
![](./figure-markdown_strict copy/unnamed-chunk-36-1.png)

    p_test + geom_line(aes(x = mileage, y = s65_pred), color='red', size=0.5)

![](./figure-markdown_strict copy/unnamed-chunk-36-2.png)
